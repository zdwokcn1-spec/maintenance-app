...
selected_tab = st.radio("メニュー選択", tab_titles, horizontal=True, label_visibility="collapsed", index=tab_titles.index(st.session_state.active_tab))
...
# ================================================================
    ...
    st.header("📦 部品在庫管理")
    v_cat = st.selectbox("分類フィルタ", categories, key="stk_filter")
    ...
    s_cat_sel = st.selectbox("分類選択", categories[1:], key="stk_cat_sel")
